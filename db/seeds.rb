...
Flight.create(departure_airport_id: 2, arrival_airport_id: 1)
Flight.create(departure_airport_id: 3, arrival_airport_id: 6)
Flight.create(departure_airport_id: 4, arrival_airport_id: 5)
Flight.create(departure_airport_id: 5, arrival_airport_id: 4)
Flight.create(departure_airport_id: 6, arrival_airport_id: 3)
